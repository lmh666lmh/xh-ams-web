    ...
    <div class="list">
      <el-table
        ...
        <el-table-column label="操作" width="200" align="center">
          <template slot-scope="scope">
            <el-button type="text" size="small" @click="routeTo('/school/detail?type=edit', scope.row.schoolId)" >修改</el-button>
            <el-button v-if="scope.row.enableFlag == 1" type="text" size="small" @click="prohibit(scope.row.schoolId, 0)" >禁用</el-button>
            <el-button v-else="" type="text" size="small" @click="prohibit(scope.row.schoolId, 1)" >启用</el-button>
            <el-dropdown trigger="click" style="margin-left: 11px;">
              <el-button type="text" size="small">更多<i class="el-icon-arrow-down el-icon--right"/></el-button>
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item>
                  <el-button type="text" size="small" @click="routeTo('/school/bookcaseDetail', scope.row.schoolId)" >绑定书柜</el-button>
                </el-dropdown-item>
                <el-dropdown-item>
                  <el-button type="text" size="small" @click="routeTo('/schoolManage', scope.row.schoolId)" >学校管理</el-button>
                </el-dropdown-item>
                <el-dropdown-item>
                  <el-button type="text" size="small" @click="routeTo('/books/index', scope.row.schoolId)" >书籍管理</el-button>
                </el-dropdown-item>
                <el-dropdown-item>
              ...
              <div class="tableList">
                <el-table
                  ...
                  <el-table-column label="基础价(￥)" align="center">
                    <template slot-scope="scope">
                      <el-input-number v-model="scope.row.projectPrice" :step="1" :min="scope.row.projectMinPrice" :max="scope.row.projectMaxPrice" controls-position="right" size="mini" label="描述文字"/>
                    </template>
                  </el-table-column>
                  ...
                  <el-table-column label="加价(￥)" align="center">
                    <template slot-scope="scope">
                      <el-input-number v-model="scope.row.schoolAddPrice" :step="1" :min="0" :max="scope.row.schoolAddMaxPrice" controls-position="right" size="mini" label="描述文字"/>
                    </template>
                  </el-table-column>
    ...
    confirm() {
      ...
      this.selfDataList.forEach((item, index) => {
        updateList.push({
          ...
          schoolAddPrice: this.toCents(item.schoolAddPrice) - 0,
